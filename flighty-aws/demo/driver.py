...
Flighty.create_handler(endpoint='doc_rec', name='xgboost', folder_path='./handler2', artifacts=['xgboost'])
...
Flighty.upload_artifact(name='gpu_featurizer', folder_path='./models/gpu_featurizer')
Flighty.create_handler(endpoint='doc_rec', name='gpu_featurizer', folder_path='./handler3', artifacts=['gpu_featurizer'])
